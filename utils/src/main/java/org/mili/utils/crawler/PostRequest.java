...
public abstract class PostRequest<T> extends Request {
    ...
    protected PostRequest(String uri, Map<String, List<String>> uriParameters, Map<String, String> headers,
    ...
    public HttpUriRequest getHttpUriRequest() {
        HttpPost httpPost = new HttpPost(createUri(getUri(), getUriParameters()));
    ...
    public abstract static class PostRequestBuilder<T, R extends Request, B extends PostRequest.PostRequestBuilder> extends RequestBuilder<R, B> {
